/********** GENERATED on 11/27/2023 at 10:39:22 by CB9980000021**************/
 @OData.entitySet.name: 'ZC_ADDED_002' 
 @OData.entityType.name: 'ZC_ADDED_002Type' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZRAP_ZC_ADDED_002 { 
 key AddedUUID : sysuuid_x16 ; 
 key IsActiveEntity : abap_boolean ; 
 @Odata.property.valueControl: 'AddedID_vc' 
 AddedID : abap.numc( 10 ) ; 
 AddedID_vc : RAP_CP_ODATA_VALUE_CONTROL ; 
...
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Shipment : association [1] to ZRAP_ZC_SHIPMENT_002 on 1 = 1; 
 } 
