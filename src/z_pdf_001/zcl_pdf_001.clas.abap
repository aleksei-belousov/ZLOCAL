CLASS zcl_pdf_001 DEFINITION PUBLIC FINAL CREATE PUBLIC .
  PUBLIC SECTION.
  ...
  PRIVATE SECTION.
    ...
    METHODS pdf_test2  importing out type ref to if_oo_adt_classrun_out.

ENDCLASS.



CLASS ZCL_PDF_001 IMPLEMENTATION.
...
*       Convert Xstring (binary) into Base64 (string)
        DATA(base64_pdf) = cl_web_http_utility=>encode_x_base64( ev_pdf ).

        out->write( base64_pdf  ). " PDF in base64 (string)
