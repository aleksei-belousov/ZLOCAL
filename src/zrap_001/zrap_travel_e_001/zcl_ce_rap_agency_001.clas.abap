CLASS zcl_ce_rap_agency_001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_business_data TYPE TABLE OF zrap_001z_travel_agency_es5.
...
CLASS ZCL_CE_RAP_AGENCY_001 IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    ENDTRY.
  ENDMETHOD. " if_rap_query_provider~select
ENDCLASS.
