/********** GENERATED on 10/04/2023 at 09:04:54 by CB9980000021**************/
 @OData.entitySet.name: 'I_PurchaseOrderItemAPI01' 
 @OData.entityType.name: 'I_PurchaseOrderItemAPI01Type' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZRAP_I_PURCHASEORDERITEMAPI01 { 
...
//On-condition is not relevant for runtime 
 _PurchaseOrder : association [1] to ZRAP_I_PURCHASEORDERAPI01 on 1 = 1; 
 } 
