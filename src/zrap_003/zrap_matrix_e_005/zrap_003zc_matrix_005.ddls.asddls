/********** GENERATED on 09/10/2023 at 17:42:38 by CB9980000021**************/
 @OData.entitySet.name: 'ZC_MATRIX_005' 
 @OData.entityType.name: 'ZC_MATRIX_005Type' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZRAP_003ZC_MATRIX_005 { 
...
//On-condition is not relevant for runtime 
 _DraftAdministrativeData1 : association [1] to ZRAP_003I_DRAFTADMINISTRATIVED on 1 = 1; 
 @OData.property.name: 'to_Item' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Item : association [0..*] to ZRAP_003ZC_ITEM_005 on 1 = 1; 
 @OData.property.name: 'to_Size' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Size : association [0..*] to ZRAP_003ZC_SIZE_005 on 1 = 1; 
 @OData.property.name: 'to_Sizehead' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Sizehead : association [0..*] to ZRAP_003ZC_SIZEHEAD_005 on 1 = 1; 
 } 
