CLASS zcl_rap_matrix_005 DEFINITION PUBLIC FINAL CREATE PUBLIC.
    ...
    PUBLIC SECTION.
        ...
        CLASS-DATA i_url         TYPE string. " VALUE 'https://my403408.s4hana.cloud.sap'.
...
*      RAISE SHORTDUMP lx_http_dest_provider_error.
  ...
  METHOD delete_matrix_item. " Delete Matrix Item
    ...
    DATA ls_key_data1        TYPE zrap_003zc_matrix_005.
    DATA ls_key_data2        TYPE zrap_003zc_item_005.
