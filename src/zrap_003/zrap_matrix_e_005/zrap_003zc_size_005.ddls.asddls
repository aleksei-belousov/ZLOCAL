/********** GENERATED on 09/10/2023 at 17:42:43 by CB9980000021**************/
 @OData.entitySet.name: 'ZC_SIZE_005' 
 @OData.entityType.name: 'ZC_SIZE_005Type' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZRAP_003ZC_SIZE_005 { 
...
//On-condition is not relevant for runtime 
 _DraftAdministrativeData123 : association [1] to ZRAP_003I_DRAFTADMINISTRATIVED on 1 = 1; 
 @OData.property.name: 'to_Matrix' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Matrix12 : association [1] to ZRAP_003ZC_MATRIX_005 on 1 = 1; 
 } 
